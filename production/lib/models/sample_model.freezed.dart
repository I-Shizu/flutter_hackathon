...
/// @nodoc
mixin _$SampleModel {
  String? get id => throw _privateConstructorUsedError; // ドキュメントIDを追加
...
class _$SampleModelImpl implements _SampleModel {
  _$SampleModelImpl({this.id, required this.name, required this.description});
